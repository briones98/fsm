...
function saveAsPNG() {
	...
	var win = window.open();
	win.document.write('<iframe src="' + pngData + '" frameborder="0" style="border:0; top:0px; left:0px; bottom:0px; right:0px; width:800; height:600; background-color: #F9F9F9; border: 1px solid #999" allowfullscreen></iframe>');
